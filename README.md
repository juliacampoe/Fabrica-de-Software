# 🎮 Fabrica de Software — Jogo Educativo 2D
...
```bash
git clone https://github.com/juliacampoe/Fabrica-de-Software.git
````

### 🎮 Abrir na Unity

1. Abrir Unity Hub
2. Clicar em **Open Project**
...
* Não modificar a pasta `Library/`
* Sempre executar `git pull` antes de começar
* Sempre executar `git push` ao finalizar alterações
* Evitar mexer em arquivos de configuração da Unity
